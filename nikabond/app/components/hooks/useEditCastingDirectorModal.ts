...
interface EditCastingDirectorModalStore {
    isOpen: boolean;
...
const useEditCastingDirectorModal = create<EditCastingDirectorModalStore>((set) => ({
    isOpen: false,
    entityId: null,
    entityData: null,
    onUpdated: null,
...
export default useEditCastingDirectorModal;
