...
const SessionEditButton: React.FC<SessionEditButtonProps> = ({ sessionId, sessionData }) => {
    const editSessionModal = useEditSessionModal();

    return (
        <button
            onClick={() => editSessionModal.open(sessionId, sessionData)}
...
export default SessionEditButton;
