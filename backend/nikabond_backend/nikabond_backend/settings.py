...
INSTALLED_APPS = [
    ...
    "allauth.socialaccount",        # optional: social logins, omit if you didn’t install [socialaccount]
...
ROOT_URLCONF = "nikabond_backend.urls"
...
WSGI_APPLICATION = "nikabond_backend.wsgi.application"
